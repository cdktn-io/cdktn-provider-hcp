...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/boundary_cluster
...
export class BoundaryCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BoundaryCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/boundary_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/boundary_cluster hcp_boundary_cluster} Resource
  *
  * @param scope The scope in which to define this construct
