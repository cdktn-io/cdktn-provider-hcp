...
// https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/waypoint_template
...
export class WaypointTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WaypointTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/waypoint_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/waypoint_template hcp_waypoint_template} Resource
  *
  * @param scope The scope in which to define this construct
