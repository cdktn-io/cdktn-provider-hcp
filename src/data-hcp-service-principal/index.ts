...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/service_principal
...
export class DataHcpServicePrincipal extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpServicePrincipal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/service_principal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/service_principal hcp_service_principal} Data Source
  *
  * @param scope The scope in which to define this construct
