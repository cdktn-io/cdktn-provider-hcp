...
// https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/packer_run_task
...
export class PackerRunTask extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PackerRunTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/packer_run_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/packer_run_task hcp_packer_run_task} Resource
  *
  * @param scope The scope in which to define this construct
