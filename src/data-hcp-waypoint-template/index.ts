...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/waypoint_template
...
export interface DataHcpWaypointTemplateConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataHcpWaypointTemplateTerraformCloudWorkspaceDetailsOutputReference extends cdktn.ComplexObject {
...
export class DataHcpWaypointTemplateVariableOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataHcpWaypointTemplateVariableOptionsList extends cdktn.ComplexList {
...
*/
export class DataHcpWaypointTemplate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpWaypointTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/waypoint_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/waypoint_template hcp_waypoint_template} Data Source
  *
  * @param scope The scope in which to define this construct
