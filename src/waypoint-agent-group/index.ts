...
// https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/waypoint_agent_group
...
export class WaypointAgentGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WaypointAgentGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/waypoint_agent_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/waypoint_agent_group hcp_waypoint_agent_group} Resource
  *
  * @param scope The scope in which to define this construct
