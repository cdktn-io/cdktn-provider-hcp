...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/vault_radar_resource_iam_policy
...
export class VaultRadarResourceIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultRadarResourceIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/vault_radar_resource_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/vault_radar_resource_iam_policy hcp_vault_radar_resource_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
