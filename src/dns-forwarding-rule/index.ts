...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/dns_forwarding_rule
...
export class DnsForwardingRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsForwardingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/dns_forwarding_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/dns_forwarding_rule hcp_dns_forwarding_rule} Resource
  *
  * @param scope The scope in which to define this construct
