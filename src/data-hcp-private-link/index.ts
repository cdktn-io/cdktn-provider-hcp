...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/data-sources/private_link
...
export class DataHcpPrivateLink extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpPrivateLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/data-sources/private_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/data-sources/private_link hcp_private_link} Data Source
  *
  * @param scope The scope in which to define this construct
