...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/waypoint_add_on_definition
...
export class WaypointAddOnDefinition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WaypointAddOnDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/waypoint_add_on_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/waypoint_add_on_definition hcp_waypoint_add_on_definition} Resource
  *
  * @param scope The scope in which to define this construct
