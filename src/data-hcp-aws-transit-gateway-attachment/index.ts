...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/data-sources/aws_transit_gateway_attachment
...
export interface DataHcpAwsTransitGatewayAttachmentConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function dataHcpAwsTransitGatewayAttachmentTimeoutsToTerraform(struct?: DataHcpAwsTransitGatewayAttachmentTimeouts | cdktn.IResolvable): any {
...
export function dataHcpAwsTransitGatewayAttachmentTimeoutsToHclTerraform(struct?: DataHcpAwsTransitGatewayAttachmentTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataHcpAwsTransitGatewayAttachmentTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataHcpAwsTransitGatewayAttachmentTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataHcpAwsTransitGatewayAttachmentTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataHcpAwsTransitGatewayAttachment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpAwsTransitGatewayAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/data-sources/aws_transit_gateway_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/data-sources/aws_transit_gateway_attachment hcp_aws_transit_gateway_attachment} Data Source
  *
  * @param scope The scope in which to define this construct
