...
// https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/dns_forwarding
...
export class DnsForwarding extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsForwarding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/dns_forwarding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/dns_forwarding hcp_dns_forwarding} Resource
  *
  * @param scope The scope in which to define this construct
