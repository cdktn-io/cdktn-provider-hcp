...
// https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/hvn_route
...
export class HvnRoute extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing HvnRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/hvn_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/hvn_route hcp_hvn_route} Resource
  *
  * @param scope The scope in which to define this construct
