...
// https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/data-sources/dns_forwarding
...
export class DataHcpDnsForwarding extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpDnsForwarding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/data-sources/dns_forwarding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/data-sources/dns_forwarding hcp_dns_forwarding} Data Source
  *
  * @param scope The scope in which to define this construct
