...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/vault_secrets_app
...
export class DataHcpVaultSecretsApp extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpVaultSecretsApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/vault_secrets_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/vault_secrets_app hcp_vault_secrets_app} Data Source
  *
  * @param scope The scope in which to define this construct
