...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/consul_cluster
...
export class ConsulCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConsulCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/consul_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/consul_cluster hcp_consul_cluster} Resource
  *
  * @param scope The scope in which to define this construct
