...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/vault_cluster
...
export interface VaultClusterConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly id?: string;
  /**
  * The minimum Vault version to use when creating the cluster. If not specified, it is defaulted to the version that is currently recommended by HCP. For example, `v1.21.2`. Refer to the [HCP Vault changelog](https://developer.hashicorp.com/hcp/docs/changelog) for available versions.
  *
...
export class VaultCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/vault_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/vault_cluster hcp_vault_cluster} Resource
  *
  * @param scope The scope in which to define this construct
