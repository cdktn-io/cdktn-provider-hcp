...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/vault_radar_integration_slack_subscription
...
export class VaultRadarIntegrationSlackSubscription extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultRadarIntegrationSlackSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/vault_radar_integration_slack_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/vault_radar_integration_slack_subscription hcp_vault_radar_integration_slack_subscription} Resource
  *
  * @param scope The scope in which to define this construct
