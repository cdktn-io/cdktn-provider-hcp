...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/log_streaming_destination
...
export class LogStreamingDestination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogStreamingDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/log_streaming_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/log_streaming_destination hcp_log_streaming_destination} Resource
  *
  * @param scope The scope in which to define this construct
