...
// https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/service_principal
...
export class ServicePrincipal extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicePrincipal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/service_principal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/service_principal hcp_service_principal} Resource
  *
  * @param scope The scope in which to define this construct
