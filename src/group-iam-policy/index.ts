...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/group_iam_policy
...
export class GroupIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/group_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/group_iam_policy hcp_group_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
