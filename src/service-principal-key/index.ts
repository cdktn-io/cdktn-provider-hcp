...
// https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/service_principal_key
...
export class ServicePrincipalKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicePrincipalKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/service_principal_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/resources/service_principal_key hcp_service_principal_key} Resource
  *
  * @param scope The scope in which to define this construct
