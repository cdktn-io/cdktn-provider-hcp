...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/service_principal_key
...
export interface ServicePrincipalKeyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class ServicePrincipalKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicePrincipalKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/service_principal_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "hcp_service_principal_key", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/service_principal_key hcp_service_principal_key} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      rotate_triggers: cdktn.hashMapper(cdktn.stringToTerraform)(this._rotateTriggers),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      rotate_triggers: {
        value: cdktn.hashMapperHcl(cdktn.stringToHclTerraform)(this._rotateTriggers),
        isBlock: false,
        type: "map",
