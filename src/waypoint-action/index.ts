...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/waypoint_action
...
export class WaypointAction extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WaypointAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/waypoint_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/waypoint_action hcp_waypoint_action} Resource
  *
  * @param scope The scope in which to define this construct
