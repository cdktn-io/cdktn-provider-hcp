...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/vault_secrets_app
...
export class VaultSecretsApp extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultSecretsApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/vault_secrets_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/vault_secrets_app hcp_vault_secrets_app} Resource
  *
  * @param scope The scope in which to define this construct
