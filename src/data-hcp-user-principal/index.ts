...
// https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/data-sources/user_principal
...
export class DataHcpUserPrincipal extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpUserPrincipal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/data-sources/user_principal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.114.0/docs/data-sources/user_principal hcp_user_principal} Data Source
  *
  * @param scope The scope in which to define this construct
