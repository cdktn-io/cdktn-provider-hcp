...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/packer_bucket_names
...
export class DataHcpPackerBucketNames extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpPackerBucketNames that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/packer_bucket_names#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/data-sources/packer_bucket_names hcp_packer_bucket_names} Data Source
  *
  * @param scope The scope in which to define this construct
