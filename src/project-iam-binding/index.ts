...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/project_iam_binding
...
export class ProjectIamBinding extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/project_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/project_iam_binding hcp_project_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
