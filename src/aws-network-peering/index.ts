...
// https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/aws_network_peering
...
export class AwsNetworkPeering extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsNetworkPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/aws_network_peering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.112.0/docs/resources/aws_network_peering hcp_aws_network_peering} Resource
  *
  * @param scope The scope in which to define this construct
