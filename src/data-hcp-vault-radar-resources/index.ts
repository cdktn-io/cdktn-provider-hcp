...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/data-sources/vault_radar_resources
...
export class DataHcpVaultRadarResources extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpVaultRadarResources that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/data-sources/vault_radar_resources#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/data-sources/vault_radar_resources hcp_vault_radar_resources} Data Source
  *
  * @param scope The scope in which to define this construct
