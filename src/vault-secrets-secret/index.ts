...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/vault_secrets_secret
...
export class VaultSecretsSecret extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultSecretsSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/vault_secrets_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/vault_secrets_secret hcp_vault_secrets_secret} Resource
  *
  * @param scope The scope in which to define this construct
