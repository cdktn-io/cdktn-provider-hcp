...
// https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/packer_bucket_iam_policy
...
export class PackerBucketIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PackerBucketIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/packer_bucket_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.113.0/docs/resources/packer_bucket_iam_policy hcp_packer_bucket_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
