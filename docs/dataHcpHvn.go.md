...
```go
import "github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11/datahcphvn"
...
&datahcphvn.DataHcpHvnConfig {
	...
	Id: *string,
	ProjectId: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11.dataHcpHvn.DataHcpHvnTimeouts,
}
```
