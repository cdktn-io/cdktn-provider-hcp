...
```go
import "github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v13/datahcphvn"
...
&datahcphvn.DataHcpHvnConfig {
	...
	Id: *string,
	ProjectId: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v13.dataHcpHvn.DataHcpHvnTimeouts,
}
```
