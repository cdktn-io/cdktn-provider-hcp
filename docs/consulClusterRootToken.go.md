...
```go
import "github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11/consulclusterroottoken"
...
&consulclusterroottoken.ConsulClusterRootTokenConfig {
	...
	Id: *string,
	ProjectId: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11.consulClusterRootToken.ConsulClusterRootTokenTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-hcp.consulClusterRootToken.ConsulClusterRootTokenConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.111.0/docs/resources/consul_cluster_root_token#id ConsulClusterRootToken#id}. |
