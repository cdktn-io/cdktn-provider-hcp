...
```go
import "github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11/packerchannel"
...
&packerchannel.PackerChannelConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11.packerChannel.PackerChannelTimeouts,
}
```
