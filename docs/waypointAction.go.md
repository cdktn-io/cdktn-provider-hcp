...
```go
import "github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11/waypointaction"
...
&waypointaction.WaypointActionConfig {
	...
	Name: *string,
	Request: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11.waypointAction.WaypointActionRequest,
	Description: *string,
	ProjectId: *string,
}
```
...
&waypointaction.WaypointActionRequest {
	Agent: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11.waypointAction.WaypointActionRequestAgent,
	Custom: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11.waypointAction.WaypointActionRequestCustom,
}
```
