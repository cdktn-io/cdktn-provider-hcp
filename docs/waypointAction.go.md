...
```go
import "github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v12/waypointaction"
...
&waypointaction.WaypointActionConfig {
	...
	Name: *string,
	Request: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v12.waypointAction.WaypointActionRequest,
	Description: *string,
	ProjectId: *string,
}
```
...
&waypointaction.WaypointActionRequest {
	Agent: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v12.waypointAction.WaypointActionRequestAgent,
	Custom: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v12.waypointAction.WaypointActionRequestCustom,
}
```
