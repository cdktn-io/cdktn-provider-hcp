...
```go
import "github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11/packerruntask"
...
&packerruntask.PackerRunTaskConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11.packerRunTask.PackerRunTaskTimeouts,
}
```
