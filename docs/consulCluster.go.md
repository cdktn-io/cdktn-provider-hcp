...
```go
import "github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v12/consulcluster"
...
&consulcluster.ConsulClusterConfig {
	...
	Size: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v12.consulCluster.ConsulClusterTimeouts,
}
```
