...
```go
import "github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11/consulcluster"
...
&consulcluster.ConsulClusterConfig {
	...
	Size: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11.consulCluster.ConsulClusterTimeouts,
}
```
