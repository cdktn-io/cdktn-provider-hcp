...
```java
import io.cdktn.providers.hcp.resource_control_policy.ResourceControlPolicy;

ResourceControlPolicy.Builder.create(Construct scope, java.lang.String id)
...
//  .provisioners(java.util.List<FileProvisioner|LocalExecProvisioner|RemoteExecProvisioner>)
    .enabledConstraints(java.util.List<java.lang.String>)
...
| --- | --- | --- |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.scope">scope</a></code> | <code>software.constructs.Construct</code> | The scope in which to define this construct. |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.id">id</a></code> | <code>java.lang.String</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.enabledConstraints">enabledConstraints</a></code> | <code>java.util.List<java.lang.String></code> | The list of constraint IDs to enable for the organization. |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.organizationId">organizationId</a></code> | <code>java.lang.String</code> | The ID of the organization to manage the resource control policy for. |
...
##### `dependsOn`<sup>Optional</sup> <a name="dependsOn" id="@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.dependsOn"></a>

- *Type:* java.util.List<io.cdktn.cdktn.ITerraformDependable>

---

##### `forEach`<sup>Optional</sup> <a name="forEach" id="@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.forEach"></a>
...
##### `enabledConstraints`<sup>Required</sup> <a name="enabledConstraints" id="@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.enabledConstraints"></a>
...
##### `organizationId`<sup>Required</sup> <a name="organizationId" id="@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.Initializer.parameter.organizationId"></a>
...
ResourceControlPolicy.isConstruct(java.lang.Object x)
```
...
ResourceControlPolicy.isTerraformElement(java.lang.Object x)
```
...
ResourceControlPolicy.isTerraformResource(java.lang.Object x)
```
...
ResourceControlPolicy.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId),ResourceControlPolicy.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId, TerraformProvider provider)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.node">node</a></code> | <code>software.constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.cdktfStack">cdktfStack</a></code> | <code>io.cdktn.cdktn.TerraformStack</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.friendlyUniqueId">friendlyUniqueId</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>java.util.Map<java.lang.String, java.lang.Object></code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.terraformResourceType">terraformResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>io.cdktn.cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.dependsOn">dependsOn</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.etag">etag</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.id">id</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.enabledConstraintsInput">enabledConstraintsInput</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.organizationIdInput">organizationIdInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.enabledConstraints">enabledConstraints</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.organizationId">organizationId</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
public java.util.List<java.lang.String> getEnabledConstraintsInput();
```
...
```java
public java.util.List<java.lang.String> getEnabledConstraints();
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicy.property.tfResourceType">tfResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
import io.cdktn.providers.hcp.resource_control_policy.ResourceControlPolicyConfig;

ResourceControlPolicyConfig.builder()
//  .connection(SSHProvisionerConnection|WinrmProvisionerConnection)
//  .count(java.lang.Number|TerraformCount)
//  .dependsOn(java.util.List<ITerraformDependable>)
//  .forEach(ITerraformIterator)
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicyConfig.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicyConfig.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicyConfig.property.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicyConfig.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicyConfig.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicyConfig.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicyConfig.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicyConfig.property.enabledConstraints">enabledConstraints</a></code> | <code>java.util.List<java.lang.String></code> | The list of constraint IDs to enable for the organization. |
| <code><a href="#@cdktn/provider-hcp.resourceControlPolicy.ResourceControlPolicyConfig.property.organizationId">organizationId</a></code> | <code>java.lang.String</code> | The ID of the organization to manage the resource control policy for. |
